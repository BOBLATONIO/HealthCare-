    ...
    <a href="{{ route('dashboard') }}" class="absolute bottom-4 px-6 right-0 flex justify-between items-center w-full">
        <div class="flex justify-center items-center  space-x-2">
            <div>
                ...
                <img class="rounded-full max-h-10  w-10 max-w-10 object-cover" src="data:image/png;base64,{{ Auth::user()->profile_photo_base64 }}" alt="avatar" />
                @else
            ...
            <div class="flex justify-center flex-col items-start">
                ...
                <p class="cursor-pointer text-xs leading-3 truncate w-34 text-gray-300">{{ auth()->user()->email }}</p>
            </div>
        </div>
